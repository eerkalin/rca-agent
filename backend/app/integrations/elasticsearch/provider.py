...
class ElasticsearchLogsProvider:
    ...
    def search_logs(
        ...
        bool_query: dict[str, Any] = {
            "filter": [{"range": {time_field: {"gte": start.isoformat(), "lte": end.isoformat()}}}],
            "must": [],
            "should": [],
        }
        ...
        return {
            ...
            "total": total,
            "hits": [{"index": hit.get("_index"), "id": hit.get("_id"), "score": hit.get("_score"), "source": hit.get("_source", {})} for hit in hits],
        }
